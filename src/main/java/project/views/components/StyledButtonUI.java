...
public class StyledButtonUI extends BasicButtonUI {
    public static class RoundedBorder implements Border {
        ...
        public @NotNull Insets getBorderInsets(@NotNull Component component) {
            return new Insets(this.radius + 1, this.radius + 1, this.radius + 2, this.radius);
        }
        public boolean isBorderOpaque() {
            return true;
        }
        public void paintBorder(@NotNull Component component, @NotNull Graphics graphics, int x, int y, int width, int height) {
    ...
    private void paintBackground (@NotNull Graphics graphics, @NotNull JComponent component, int yOffset) {
        @NotNull Dimension size = component.getSize();
